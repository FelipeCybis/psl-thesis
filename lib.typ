...
#let psl-back-cover(
  ...
  set page(
    ...
    margin: (left: 1.5cm, right: 2cm, top: 1.4cm, bottom: 1.4cm),
  )

  show heading: it => {
    set text(fill: colors.psl, weight: "light", size: 14pt)
